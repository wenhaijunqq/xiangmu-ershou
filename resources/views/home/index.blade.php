...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function beijing(){
                for (var j = 1; j < 5; j++) {
                    document.getElementById('idimg'+j).style.display = 'none';
                }
                document.getElementById('idimg'+y).style.display = 'block';
                y++;
                if(y == 5){
                    y = 1;
                }
    ...
    <body style="background-color: #f5f5f7">
        ...
        <div id="body">
            ...
            <div class="jaioyiguohu">
                ...
                <div  class="idimg" id="idimg3"><img  style="height: 400px;margin-left: -210px;" src="img/03qianshuhetong@2x.jpg" alt=""></div>
                <div class="idimg" id="idimg4"><img  style="height: 400px;margin-left: -210px;" src="img/buy-step-deal.jpg" alt=""></div>
            ...
            <div class="company-info clearfix">
                ...
                <div class="basic-info">
                    ...
                    <div class="protect protect-icon-xin315 clearfix">
                        <a id="___szfw_logo___" href="#" class="icon-xin" target="_blank"></a>
                        <a id="___szfw_logo___1" href="#" class="icon-315" target="_blank"></a>
                    </div>
                </div>
            </div>
            <!--seo 链接 -->
