       ...
       <div class="widget-body am-fr">
        <form class="am-form tpl-form-border-form tpl-form-border-br " id="carAdd" enctype="multipart/form-data">
         ...
         <div class="am-form-group">
          ...
          <div class="am-u-sm-9">
           <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入标题文字" name="title" value="{{$data->car_typeName}}" />
          ...
          <div class="am-u-sm-9">
           <div class="am-form-group am-form-file">
            <div class="tpl-form-file-img">
             <img src="{{$data->car_icon}}" alt=""  id="myimg" style="width:200px;height:200px"/>
            </div>
           ...
           <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
             <button type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success" id="sumbit" onclick="updateCar({{$data->id}})">提交</button>
            </div>
           </div>
          </div>
         </div>
...
<script type="text/javascript">
        ...
        function updateCar(id){
            ...
            //判断是否上传文件
                ...
                $.post("/admin/CarType/updateCar/"+id,{'_token':'{{csrf_token()}}','car_typeName':title,'car_icon':imgPath,'tid':0},function(data){
                            //alert(data);
                        if(data == 1){
                            layer.alert('添加修改成功', {
